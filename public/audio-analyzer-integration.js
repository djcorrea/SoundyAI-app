...
// ============================================================================
// 🌍 EXPORTAÇÕES GLOBAIS - Funções expostas para uso no HTML
// ============================================================================
window.openAudioModal = function() {
    console.log('🎵 [GLOBAL] openAudioModal chamada');
    if (typeof openWelcomeModal === 'function') {
        openWelcomeModal();
    } else {
        console.error('❌ openWelcomeModal não encontrada!');
    }
};
...
console.log('✅ [EXPORTS] Funções de modal exportadas globalmente:', {
    ...
    openWelcomeModal: typeof window.openWelcomeModal,
    closeWelcomeModal: typeof window.closeWelcomeModal,
