...
// ⚠️ REMOVIDO: Funções expostas que causavam loop infinito
// As funções serão expostas diretamente no final do arquivo após serem definidas
...
// 🎵 EXPOSIÇÃO GLOBAL DAS FUNÇÕES DE MODAL DE GÊNERO (SEM LOOPS)
if (typeof window !== 'undefined') {
    // Expor funções diretamente sem wrappers
    window.openGenreSelectionModal = openGenreSelectionModal;
    window.closeGenreSelectionModal = closeGenreSelectionModal;
    window.selectGenre = selectGenre;
    window.updateSelectedGenreDisplay = updateSelectedGenreDisplay;
    
    console.log('✅ Funções de modal de gênero expostas globalmente (sem loops)');
}
