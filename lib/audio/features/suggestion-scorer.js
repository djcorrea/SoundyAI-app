...
class SuggestionScorer {
     ...
     * @param {number} target - Valor alvo (ou objeto range para bandas)
     * @param {number} tolerance - Tolerância (não usado para bandas com range)
     * @param {Object} options - Opções adicionais { isBand: boolean }
     * @returns {number} Z-score ou distance para bandas
     */
