...
class LUFSMeter {
  ...
  calculateLUFS(leftChannel, rightChannel) {
    ...
    // LRA (Loudness Range) – DETERMINÍSTICO: sempre usar R128 oficial com gating relativo (-20 LU)
    ...
    // CORREÇÃO DETERMINISMO: sempre usar R128 LRA (EBU 3342 compliant) para garantir resultados consistentes
