...
export async function runExpirePlansJob() {
  ...
  try {
    ...
    // ═══════════════════════════════════════════════════════════════
    // PASSO 4: Verificar assinaturas Stripe canceladas que passaram do período
    // ═══════════════════════════════════════════════════════════════
    ...
    stats.total = proSnapshot.size + plusSnapshot.size + studioSnapshot.size + canceledSnapshot.size;
