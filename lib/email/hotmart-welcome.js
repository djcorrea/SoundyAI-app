...
/**
 * FROM_EMAIL fixo para domínio verificado no Resend
 * 
 * ✅ DOMÍNIO CONFIGURADO: send.soundyai.com.br (SPF/MX no Cloudflare)
 * ⚠️ NUNCA usar @soundyai.com.br (SPF root bloqueado)
 * ⚠️ NUNCA usar onboarding@resend.dev (só funciona para testes)
 */
const FROM_EMAIL = 'SoundyAI <noreply@send.soundyai.com.br>';
...
export async function sendWelcomeProEmail({ 
  ...
  try {
    ...
    // Log ANTES do envio: destinatário e subject
