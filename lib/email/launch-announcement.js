    ...
    <tr>
      <td align="center" style="padding: 40px 20px;">
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 600px; background: linear-gradient(180deg, #0f0f1a 0%, #0a0a0f 100%); border-radius: 16px; overflow: hidden; border: 1px solid rgba(139, 92, 246, 0.08);">
          ...
          <!-- Divisor antes dos bônus -->
          <tr>
            <td style="padding: 0 80px 32px 80px;">
              <div style="height: 1px; background: linear-gradient(90deg, transparent, rgba(139, 92, 246, 0.1), transparent);"></div>
            </td>
          </tr>
          
          <!-- Texto introdutório dos bônus -->
          <tr>
            <td align="center" class="mobile-padding" style="padding: 0 50px 24px 50px;">
              <p class="mobile-text" style="margin: 0; font-size: 14px; line-height: 1.7; color: rgba(255, 255, 255, 0.55);">
                Enquanto o lançamento não acontece, você já pode aproveitar alguns bônus exclusivos:
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td align="center" style="padding: 0 40px 48px 40px;">
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: 0 auto;">
                <tr>
                  <!-- Botão E-book -->
                  <td class="mobile-bonus" style="padding-right: 12px;">
                    <a href="#" target="_blank" style="display: inline-block; padding: 14px 24px; background: rgba(139, 92, 246, 0.12); border: 1px solid rgba(139, 92, 246, 0.25); border-radius: 10px; font-size: 14px; font-weight: 500; color: #a78bfa; text-decoration: none; transition: all 0.2s ease;">
                      📘 Baixar e-book de melodias
                    </a>
                    <!-- TODO: Substituir "#" pelo link real do e-book -->
                  </td>
                  ...
                  <!-- Botão Pack -->
                  <td class="mobile-bonus">
                    <a href="#" target="_blank" style="display: inline-block; padding: 14px 24px; background: rgba(139, 92, 246, 0.12); border: 1px solid rgba(139, 92, 246, 0.25); border-radius: 10px; font-size: 14px; font-weight: 500; color: #a78bfa; text-decoration: none; transition: all 0.2s ease;">
                      🎧 Baixar pack de samples e presets
                    </a>
                    <!-- TODO: Substituir "#" pelo link real do pack -->
                  </td>
                </tr>
              </table>
              
              <p style="margin: 16px 0 0 0; font-size: 12px; color: rgba(255, 255, 255, 0.3); font-style: italic;">
                Links serão liberados em breve
              </p>
            </td>
          </tr>
