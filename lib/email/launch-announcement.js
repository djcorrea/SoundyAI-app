...
const SALES_PAGE_URL = 'https://musicaprofissional.com.br';
    ...
    <tr>
      <td align="center" style="padding: 40px 20px;">
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 600px; background: linear-gradient(180deg, #0f0f1a 0%, #0a0a0f 100%); border-radius: 16px; overflow: hidden; border: 1px solid rgba(139, 92, 246, 0.08);">
          ...
          <tr>
            <td align="center" class="mobile-padding" style="padding: 0 50px 32px 50px;">
              ...
              <p class="mobile-text" style="margin: 12px 0 0 0; font-size: 15px; line-height: 1.7; color: rgba(255, 255, 255, 0.65);">
                Por estar na lista antes do lançamento, você também garante acesso a um treinamento completo:
              </p>
            </td>
          </tr>
          ...
          <!-- Bloco de Resumo Premium -->
          <tr>
            <td align="center" class="mobile-padding" style="padding: 0 50px 32px 50px;">
              <p class="mobile-text" style="margin: 0 0 16px 0; font-size: 15px; line-height: 1.7; color: rgba(255, 255, 255, 0.7); font-weight: 600;">
                Os bônus fazem parte do acesso ao SoundyAI Studio.
              </p>
              <p class="mobile-text" style="margin: 0; font-size: 15px; line-height: 1.75; color: rgba(255, 255, 255, 0.65);">
                Ao garantir sua vaga, você desbloqueia:
              </p>
            </td>
          </tr>
          ...
          <!-- Lista de Benefícios -->
          <tr>
            <td align="center" style="padding: 0 60px 32px 60px;">
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                  <td style="padding: 10px 0; text-align: left;">
                    <span style="color: #8b5cf6; font-size: 16px; margin-right: 8px;">✓</span>
                    <span style="color: rgba(255, 255, 255, 0.75); font-size: 14px; line-height: 1.6;">Ferramentas de análise profissional</span>
                  </td>
                </tr>
                <tr>
                  <td style="padding: 10px 0; text-align: left;">
                    <span style="color: #8b5cf6; font-size: 16px; margin-right: 8px;">✓</span>
                    <span style="color: rgba(255, 255, 255, 0.75); font-size: 14px; line-height: 1.6;">Direção técnica clara para mix e master</span>
                  </td>
                </tr>
                <tr>
                  <td style="padding: 10px 0; text-align: left;">
                    <span style="color: #8b5cf6; font-size: 16px; margin-right: 8px;">✓</span>
                    <span style="color: rgba(255, 255, 255, 0.75); font-size: 14px; line-height: 1.6;">E os bônus exclusivos anunciados anteriormente</span>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td align="center" class="mobile-padding" style="padding: 0 50px 32px 50px;">
              <p class="mobile-text" style="margin: 0; font-size: 14px; line-height: 1.7; color: rgba(255, 255, 255, 0.55); font-style: italic;">
          ...
          <tr>
            <td align="center" style="padding: 0 40px 16px 40px;">
              <a href="${SALES_PAGE_URL}" target="_blank" class="mobile-btn" style="display: inline-block; padding: 18px 42px; background: linear-gradient(135deg, #8b5cf6 0%, #6366f1 100%); border-radius: 12px; font-size: 16px; font-weight: 600; color: #ffffff; text-decoration: none; letter-spacing: 0.2px; box-shadow: 0 8px 32px rgba(139, 92, 246, 0.4); transition: all 0.2s ease;">
...
✓ Direção técnica clara para mix e master
✓ E os bônus exclusivos anunciados anteriormente
