        ...
        <table role="presentation" class="container" width="600" cellpadding="0" cellspacing="0" border="0" style="width:100%; max-width:600px; margin:0 auto; background-color:#ffffff; border-radius:16px; box-shadow:0 20px 60px rgba(0,0,0,0.4);">
          ...
          <tr>
            <td class="mobile-padding" style="padding:40px 24px 32px; background-color:#ffffff;">
              <h2 style="margin:0 0 16px; font-size:28px; font-weight:700; color:#0f0f1e; line-height:1.2; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;">Seu acesso ao SoundyAI PRO está ativo</h2>
              ...
              <p style="margin:0 0 12px; font-size:15px; line-height:1.6; color:#4b5563; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif; word-break:break-word; overflow-wrap:anywhere;">A <strong>SoundyAI</strong> analisa sua música com métricas profissionais e recomenda ajustes práticos. Sua assinatura PRO está ativa até <strong>${formattedExpiration}</strong>.</p>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 24px;">
                <tr>
                  <td style="padding:32px 20px; background:linear-gradient(135deg, #f0f3ff 0%, #faf5ff 100%); border-radius:12px; border:1px solid #e0e7ff;">
                    ...
                    <p style="margin:20px 0 0; font-size:12px; color:#6b7280; line-height:1.5; text-align:center; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;">Este link é seguro e expira em 1 hora.</p>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td class="mobile-padding" style="padding:32px 24px; background-color:#fafafa;">
              <h3 style="margin:0 0 20px; font-size:18px; font-weight:700; color:#0f0f1e; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;">O que você desbloqueou no PRO</h3>
