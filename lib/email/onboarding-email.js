    ...
    <tr>
      <td align="center" style="padding:40px 0;">
        ...
        <table role="presentation" class="container" width="600" cellpadding="0" cellspacing="0" border="0" style="width:100%; max-width:600px; margin:0 auto; background-color:#ffffff; border-radius:16px; box-shadow:0 20px 60px rgba(0,0,0,0.4);">
          ...
          <!-- SUPORTE -->
          <tr>
            <td class="mobile-padding" style="padding:32px 24px; background-color:#ffffff; border-top:1px solid #e5e7eb;">
              <h3 style="margin:0 0 16px; font-size:16px; font-weight:700; color:#0f0f1e; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;">💬 Precisa de ajuda?</h3>
              
              <p style="margin:0 0 12px; font-size:14px; line-height:1.6; color:#4b5563; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;">Se tiver qualquer problema com o acesso, entre em contato:</p>
              
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="padding:8px 0; font-size:14px; color:#374151; line-height:1.6; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;">
                    <strong style="color:#6366f1;">📱 WhatsApp:</strong> (34) 99841-2461
                  </td>
                </tr>
                <tr>
                  <td style="padding:8px 0; font-size:14px; color:#374151; line-height:1.6; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;">
                    <strong style="color:#6366f1;">✉️ E-mail:</strong> soundyaibr@gmail.com
                  </td>
                </tr>
              </table>
            </td>
...
💬 PRECISA DE AJUDA?
Se tiver qualquer problema com o acesso, entre em contato:

📱 WhatsApp: (34) 99841-2461
✉️ E-mail: soundyaibr@gmail.com
