...
export const PLAN_LIMITS = {
  /**
   * 🆓 PLANO FREE (R$ 0/mês)
   * - 3 análises/mês (após limite: só score + LUFS, TP, DR)
  ...
  /**
   * ➕ PLANO PLUS (R$ 47/mês)
   * - 25 análises/mês (completas com sugestões)
   * - 80 mensagens/mês
   ...
   * - Análises "ilimitadas" (limite invisível: 150/mês)
   * - Chat "ilimitado" (limite invisível: 500 mensagens/mês)
  ...
  pro: {
    ...
    // 🔢 LIMITES DE USO (com limites invisíveis de segurança)
    limits: {
      audioAnalyses: {
        limit: -1,                   // Ilimitado
        invisibleLimit: 150,         // Limite de segurança (não mostrado ao usuário)
        period: 'month',
        description: 'Análises ilimitadas de áudio',
        afterLimit: 'full'           // Sempre análise completa
      },
 ...
 * @param {string} planId - ID do plano ('free', 'plus', 'pro', 'enterprise')
